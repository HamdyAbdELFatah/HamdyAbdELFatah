...
###### A passionate Android Developer and Competitive Programmer who has great  experience using Android SDK with Java & Kotlin programming languages, applying new  technologies, and following best practices to make the code clean, readable, usable, and  efficient by using the best algorithm to solve the problem
